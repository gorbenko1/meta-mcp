    ...
    server.tool("get_capabilities", {}, async () => {
      const capabilities = {
        ...
        tools_available: [
          ...
          // Creative tools
          "list_creatives - List all ad creatives in an account",
          "create_ad_creative - Create new ad creative with images/videos",
          "validate_creative_setup - Validate creative parameters before creation",
          "validate_creative_enhanced - Enhanced validation with detailed checks",
          "preview_ad - Generate HTML preview of creative",
          "get_creative_best_practices - Comprehensive creative guidelines",
          "troubleshoot_creative_issues - Diagnose and fix creative problems",
          "analyze_account_creatives - Bulk analysis of account creatives",
          "upload_creative_asset - Get asset upload guidance",
          "setup_ab_test - A/B testing strategies for creatives",
          "get_creative_performance - Performance analysis guidance",
          // OAuth tools
          "generate_auth_url",
