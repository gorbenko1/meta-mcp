...
export function registerCreativeTools(server: McpServer, metaClient: MetaApiClient) {
  ...
  // List Creatives Tool
  server.tool('list_creatives', ListCreativesSchema, async ({ 
    account_id, 
    limit, 
    after 
  }) => {
  ...
  server.tool('create_ad_creative', CreateAdCreativeSchema, async ({
    account_id,
    name,
    title,
    body,
  ...
  // Preview Ad Tool
  server.tool('preview_ad', PreviewAdSchema, async ({
    creative_id,
    ad_format,
    product_item_ids
  }) => {
  ...
  server.tool('upload_creative_asset', CreateAdCreativeSchema, async ({
    account_id,
    name
  }) => {
    try {
  ...
  // Setup A/B Test Tool
  server.tool('setup_ab_test', CreateAdCreativeSchema, async ({
    account_id,
    name
  }) => {
    try {
  ...
  server.tool('get_creative_performance', PreviewAdSchema, async ({
    creative_id
  }) => {
    try {
