...
export function registerCampaignTools(server: McpServer, metaClient: MetaApiClient) {
  ...
  // List Campaigns Tool
  server.tool('list_campaigns', ListCampaignsSchema.shape, async ({ account_id, status, limit, after }) => {
    try {
  ...
  server.tool('create_campaign', CreateCampaignSchema, async ({ 
    account_id, 
    name, 
    objective, 
    status, 
  ...
  server.tool('update_campaign', UpdateCampaignSchema, async ({ 
    campaign_id, 
    name, 
    status, 
    daily_budget, 
  ...
  // Pause Campaign Tool
  server.tool('pause_campaign', DeleteCampaignSchema, async ({ campaign_id }) => {
    try {
  ...
  server.tool('resume_campaign', DeleteCampaignSchema, async ({ campaign_id }) => {
    try {
  ...
  server.tool('delete_campaign', DeleteCampaignSchema, async ({ campaign_id }) => {
    try {
  ...
  // List Ad Sets Tool
  server.tool('list_ad_sets', ListAdSetsSchema, async ({ 
    campaign_id, 
    account_id, 
    status, 
    limit, 
  ...
  // Create Ad Set Tool
  server.tool('create_ad_set', CreateAdSetSchema, async ({ 
    campaign_id,
    name,
    daily_budget,
    lifetime_budget,
  ...
  // List Ads Tool
  server.tool('list_ads', ListAdSetsSchema, async ({ 
    campaign_id, 
    account_id, 
    status, 
    limit, 
