...
export function registerAudienceTools(server: McpServer, metaClient: MetaApiClient) {
  ...
  // List Audiences Tool
  server.tool('list_audiences', ListAudiencesSchema, async ({ 
    account_id, 
    type, 
    limit, 
    after 
  ...
  server.tool('create_custom_audience', CreateCustomAudienceSchema, async ({
    account_id,
    name,
    description,
    subtype,
  ...
  server.tool('create_lookalike_audience', CreateLookalikeAudienceSchema, async ({
    account_id,
    name,
    origin_audience_id,
    country,
  ...
  server.tool('estimate_audience_size', EstimateAudienceSizeSchema, async ({
    account_id,
    targeting,
    optimization_goal
  }) => {
  ...
  server.tool('update_custom_audience', CreateCustomAudienceSchema, async ({
    account_id,
    name,
    description,
    retention_days
  ...
  server.tool('delete_audience', ListAudiencesSchema, async ({ account_id }) => {
    try {
  ...
  server.tool('get_audience_insights', EstimateAudienceSizeSchema, async ({
    account_id,
    targeting
  }) => {
    try {
