...
export function registerAnalyticsTools(server: McpServer, metaClient: MetaApiClient) {
  ...
  // Get Insights Tool
  server.tool('get_insights', GetInsightsSchema, async ({ 
    object_id,
    level,
    date_preset,
    time_range,
  ...
  server.tool('compare_performance', ComparePerformanceSchema, async ({
    object_ids,
    level,
    date_preset,
    time_range,
  ...
  server.tool('export_insights', ExportInsightsSchema, async ({
    object_id,
    level,
    format,
    date_preset,
  ...
  server.tool('get_campaign_performance', GetInsightsSchema, async (params) => {
    try {
      ...
      const campaignParams = {
        ...
        fields: params.fields || ['impressions', 'clicks', 'spend', 'ctr', 'cpc', 'cpm', 'reach', 'frequency']
      };
  ...
  server.tool('get_attribution_data', GetInsightsSchema, async (params) => {
    try {
      ...
      const attributionParams = {
        ...params,
        fields: params.fields || ['impressions', 'clicks', 'spend', 'actions', 'cost_per_action_type'],
